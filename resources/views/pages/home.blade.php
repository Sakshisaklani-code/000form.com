...
<section class="lp-hero">
    ...
    <div class="lp-container">
        ...
        {{-- ── BOTTOM: dashboard + email preview side by side ── --}}
...
<section class="lp-hiw" id="how-it-works">
    <div class="lp-container">
        ...
        <div class="lp-steps">
            ...
            <div class="lp-step">
                ...
                <div class="lp-step__body">
                    ...
                    <a href="{{ route('signup') }}" class="lp-step__link">
                        Sign up now
        ...
        <div class="lp-hiw__cta">
            ...
            <a href="{{ route('pricing') }}" class="lp-btn lp-btn--ghost lp-btn--lg">
                View pricing
            </a>
        </div>
    ...
    <div class="lp-container">
        <div class="lp-pt__inner">
            <div class="lp-pt__left">
                ...
                <a href="{{ route('pricing') }}" class="lp-btn lp-btn--primary">
                    See all plans
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                </a>
            </div>
            <div class="lp-pt__plans">
                <div class="lp-pt__plan">
                    ...
                    <a href="{{ route('signup') }}" class="lp-pt__plan-btn lp-pt__plan-btn--outline">Get started</a>
                </div>
                <!-- <div class="lp-pt__plan">
                    <div class="lp-pt__plan-name">Other Plans</div>
                    <a href="{{ route('signup') }}" class="lp-pt__plan-btn lp-pt__plan-btn--outline">Personal</a>
                    <a href="{{ route('signup') }}" class="lp-pt__plan-btn lp-pt__plan-btn--outline">Professional</a>
                    <a href="{{ route('signup') }}" class="lp-pt__plan-btn lp-pt__plan-btn--outline">Business</a>
                </div> -->
