...
{{-- ═══════════════════════════════════════════════════════
     CORE SECTION  ← paste right after hero </section>
═══════════════════════════════════════════════════════ --}}
    ...
    <div class="lp-container">
        ...
        <div class="lp-split">
            ...
            <div class="lp-split__copy">
                ...
                <a href="{{ route('signup') }}" class="lp-split__cta lp-split__cta--core">
...
{{-- ═══════════════════════════════════════════════════════
     EXPRESS SECTION  ← paste right after the Core section
═══════════════════════════════════════════════════════ --}}
<section class="lp-express">
    ...
    <div class="lp-container">
        ...
        <div class="lp-split lp-split--reverse">
            ...
            {{-- LEFT: steps (visually on right due to reverse) --}}
            <div class="lp-split__steps">
            ...
            {{-- RIGHT: copy (visually on left due to reverse) --}}
            <div class="lp-split__copy">
