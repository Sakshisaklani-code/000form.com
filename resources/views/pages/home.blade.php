    ...
    <div class="lp-container">
        ...
        <div class="lp-pt__grid">
            ...
            <div class="lp-pt__card">
                ...
                <a href="{{ route('pricing') }}" class="lp-pt__btn lp-pt__btn--ghost">
                    View plan
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                </a>
            </div>
            ...
            <div class="lp-pt__card lp-pt__card--featured">
                ...
                <a href="{{ route('pricing') }}" class="lp-pt__btn lp-pt__btn--solid">
                    View plan
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                </a>
            </div>
        ...
        <div class="lp-pt__footer">
            ...
            <a href="{{ route('pricing') }}">See full comparison →</a>
        </div>
