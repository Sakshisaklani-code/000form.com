...
<div style="min-height: calc(100vh - 64px); display: flex; align-items: center; justify-content: center; padding: 2rem; background: var(--bg-primary);">
    <div style="max-width: 420px; width: 100%; text-align: center;">
        ...
        <button onclick="window.history.go({{ session('had_captcha') ? -2 : -1 }})" style="display: inline-flex; align-items: center; gap: 0.5rem; background: var(--accent); color: var(--bg-primary); font-weight: 600; padding: 0.75rem 1.5rem; border-radius: 8px; border: none; font-size: 0.95rem; cursor: pointer; transition: all 0.2s; font-family: var(--font-display);">
            ← Go Back
        </button>
    </div>
</div>
