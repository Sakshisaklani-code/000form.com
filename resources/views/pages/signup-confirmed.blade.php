...
<body style="margin:0;padding:0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;background-color:#0a0a0a;">
    <div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:20px;">
        <div style="background:#111111;border:1px solid #1a1a1a;border-radius:12px;padding:48px;max-width:480px;width:100%;text-align:center;">
            ...
            @if($success)
            <a href="{{ route('login') }}" style="display:inline-block;padding:14px 32px;background-color:#00ff88;color:#050505;text-decoration:none;font-weight:600;border-radius:8px;font-size:15px;">
                Login to your account
            </a>
            @else
            <a href="{{ route('signup') }}" style="display:inline-block;padding:14px 32px;background-color:#00ff88;color:#050505;text-decoration:none;font-weight:600;border-radius:8px;font-size:15px;">
