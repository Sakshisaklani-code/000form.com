...
@section('title', 'Payment Successful - 000form')
...
<div class="proc">
    <div class="proc-box">
        ...
        {{-- Success state (hidden until activated) --}}
        ...
        {{-- Payment details shown after activation --}}
        <div class="proc-details" id="proc-details">
            ...
            <div class="proc-detail-row">
                ...
                <span class="proc-detail-value" id="detail-txn-id">
                    {{-- Download invoice — only shown if invoice_url exists --}}
        ...
        {{-- Action buttons shown after activation --}}
        <div style="margin-top:1rem;">
            <a href="{{ route('billing.portal') }}" class="proc-btn proc-btn-primary" id="btn-billing">
                View Plan Details →
            </a>
            <a href="{{ route('dashboard') }}" class="proc-btn proc-btn-outline" id="btn-dashboard">
                Go to Dashboard
            </a>
        </div>

        {{-- Fallback button shown if timeout --}}
        <a href="{{ route('billing.portal') }}" class="proc-btn proc-btn-fallback" id="btn-fallback">
            Go to Dashboard →
        </a>
...
<script>
    (function () {
        ...
        async function checkStatus() {
            ...
            try {
                const statusUrl = '{{ route('subscription.status') }}'
