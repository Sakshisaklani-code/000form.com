...
<div class="wrapper">
    <div class="payment-card">
        {{-- ── HEADER ── with success badge BELOW 000form --}}
        <div class="header">
        ...
        <div class="body">
            {{-- Plan highlight card --}}
            <div class="plan-card">
                <div class="plan-cycle">{{ ucfirst($billingCycle) }} Plan</div>
                <div class="plan-name">{{ ucfirst($planName) }}</div>
                <div class="plan-amount">{{ $amount }}</div>
                <div class="plan-renewal">Renews on {{ $periodEnd }}</div>
            </div>
            ...
            <table class="details-table">
                ...
                <tr>
                    ...
                    <td class="value accent">{{ $amount }} {{ strtoupper($currency) }}</td>
                </tr>
                <tr>
            ...
            {{-- TWO BUTTONS: side by side (left and right alignment) --}}
            <div class="button-group">
                <a href="{{ config('app.url') }}/billing" class="btn-primary">
                ...
                @if($invoiceUrl)
                    <a href="{{ $invoiceUrl }}" class="btn-outline" target="_blank">
                        <svg class="icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="footer">
            ...
            <p style="margin-top: 20px;">
                © {{ date('Y') }} 000form · All rights reserved
            </p>
        </div>
    </div>
</div>
