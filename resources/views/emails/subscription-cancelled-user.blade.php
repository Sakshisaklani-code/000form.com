...
<div class="wrapper">
    ...
    <div class="header">
        ...
        @if($cancelType === 'scheduled_change')
            ...
            <p>
                The pending upgrade to <strong>{{ ucfirst($cancelledNewPlan) }}</strong> has been removed.
                You'll stay on your current <strong>{{ ucfirst($planName) }}</strong> plan.
            </p>
        @else
    ...
    <div class="body">
        ...
        @if($cancelType === 'scheduled_change')
            ...
            {{-- Plan visual: keeping current, cancelled upgrade --}}
            <div class="plan-change">
                <div class="plan-pill">
                    <div class="pill-label">Staying On</div>
                    <div class="pill-name keep">{{ ucfirst($planName) }}</div>
                    <div class="pill-cycle">{{ ucfirst($billingCycle) }}</div>
                </div>
                <div class="cross">✕</div>
                <div class="plan-pill">
                    <div class="pill-label">Upgrade Cancelled</div>
                    <div class="pill-name gone">{{ ucfirst($cancelledNewPlan) }}</div>
                    <div class="pill-cycle">{{ ucfirst($cancelledNewBilling) }}</div>
                </div>
            </div>
            ...
            <div class="callout callout-sched">
                ...
                <div class="callout-text">
                    ...
                    Your {{ ucfirst($planName) }} plan stays active. The scheduled upgrade to {{ ucfirst($cancelledNewPlan) }} has been fully removed — no action needed.
                </div>
            </div>
        ...
        @else
            ...
            <div class="callout callout-sub">
                ...
                <div class="callout-text">
                    @if($accessUntil)
                        <strong>Full access until {{ $accessUntil }}</strong>
                    @else
        ...
        <div class="cta-wrap">
            ...
            @else
                <a href="{{ config('app.url') }}/billing" class="cta-btn">Reactivate Subscription →</a>
            @endif
        </div>
