...
<head>
    ...
    <title>Verify Your Submission - 000form</title>
    ...
    <main class="main">
        ...
        <div class="text-center">
            ...
            <div class="using-line">
                <span>You are using</span> 000form.com
            </div>
        </div>
        ...
        <div class="verify-card">
            <!-- Form Info -->
            <div class="form-info">
                <p class="label">Verifying submission for</p>
                <p class="name"><?php echo e($form->name ?? 'Contact Form'); ?></p>
            </div>
            
            <!-- reCAPTCHA Form -->
            <form action="<?php echo e(route('captcha.verify', $form->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Git-folders\000form.com\resources\views\captcha-page.blade.php ENDPATH**/ ?>