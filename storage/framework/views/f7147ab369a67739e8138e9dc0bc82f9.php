        ...
        <?php if($subscription): ?>
            ...
            <div class="bp-card">
                ...
                <div class="bp-plan-row">
                    ...
                    <?php if (! ($subscription->plan_name->value === 'business')): ?>
                        <a href="<?php echo e(route('pricing')); ?>" class="bp-btn bp-btn-primary">
                            ↑ Upgrade Plan
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <div class="bp-card">
                ...
                <div class="bp-details-grid">
                    ...
                    <div class="bp-detail-item">
                        ...
                        <div class="bp-detail-value">
                            <?php echo e($subscription->last_payment_at?->format('M d, Y') ?? '—'); ?>
                    ...
                    <div class="bp-detail-item">
                        ...
                        <div class="bp-detail-value">
                            <a href="<?php echo e(route('billing.portal-link')); ?>" class="bp-invoice-dl">
                                Update card →
                            </a>
                        </div>
                    </div>
            ...
            <div class="bp-card">
                ...
                <div class="bp-actions">
                    ...
                    <?php if($subscription->isActive() && !$subscription->cancel_at_period_end): ?>
                        <?php if($subscription->billing_cycle === 'monthly'): ?>
                            <form method="POST" action="<?php echo e(route('billing.change-plan')); ?>" style="display:inline;">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="plan"    value="<?php echo e($subscription->plan_name->value); ?>">
                    ...
                    <?php if($subscription->isActive() && !$subscription->cancel_at_period_end): ?>
                        <form method="POST" action="<?php echo e(route('billing.cancel')); ?>" style="display:inline;">
                            ...
                            <button type="submit" class="bp-btn bp-btn-danger"
                                    onclick="return confirm('Cancel your subscription? You keep full access until <?php echo e($subscription->current_period_end?->format('M d, Y')); ?>. No further charges.')">
                                ✕ Cancel Subscription
                            </button>
                        </form>
                    <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="bp-invoice-amount">
                                            <?php echo e($symbol); ?><?php echo e($amount); ?>
                                    ...
                                    <td>
                                        <?php if($invoice->invoice_url): ?>
                                            <a href="<?php echo e($invoice->invoice_url); ?>"
                                            target="_blank"
                                            class="bp-invoice-dl">
                                                ↓ PDF
                                            </a>
