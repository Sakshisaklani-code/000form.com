                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width: 600px;">
                    ...
                    <tr>
                        <td style="background-color: #111111; border-radius: 12px; padding: 32px; border: 1px solid #1a1a1a;">
                            ...
                            <div style="color: #d0d0d0; line-height: 1.8; font-size: 15px; white-space: pre-wrap;"><?php echo e($messageContent); ?></div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding-top: 24px; text-align: center;">
                            <p style="margin: 0; color: #555555; font-size: 12px;">
                                This is an automated response from <a href="<?php echo e(config('app.url')); ?>" style="color: #00ff88; text-decoration: none;"><?php echo e($form->name); ?></a>
                            </p>
...
</html><?php /**PATH C:\Git-folders\000form.com\resources\views/emails/auto-response.blade.php ENDPATH**/ ?>