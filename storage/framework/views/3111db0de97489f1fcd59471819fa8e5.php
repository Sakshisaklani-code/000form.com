...
<style>
    .ajax-docs-wrap { padding: 8rem 0 0rem; }
    ...
    .docs-nav a {
        ...
        padding: 0.38rem 1.25rem; font-size: 1rem; color: #666;
    ...
    /* ── Section cards ── */
    .docs-section {
        margin-bottom: 3.5rem; border: 1px solid #1e1e1e;
...
<div class="ajax-docs-wrap">
    <section class="library-hero" style="margin-top: 3rem">
        <div class="hero-bg">
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <h1 class="hero-title">
                    AJAX Form Submission <span class="highlight"> Seamless & Fast</span>
                </h1>
                
                <p class="hero-description">
                    No page reloads. No extra setup. 
                    Just add a header, copy the code, and submit your forms instantly—
                ...
                <!-- <div class="test-section" id="test-ajax">
                    ...
                    <div class="test-section-body">
                        ...
                        <div class="note-box warn" style="margin-bottom:1rem;">
                            <i class="bi bi-exclamation-triangle-fill"></i>
                            <span>Enter your full endpoint URL with your <strong>verified email</strong> — e.g. <span class="ic">https://000form.com/f/you@email.com</span>. Verify your email on the <a href="<?php echo e(route('playground.index')); ?>" style="color:#f8c77e;">Playground</a> first.</span>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Git-folders\000form.com\resources\views/pages/ajax.blade.php ENDPATH**/ ?>