    ...
    <div class="card card-edit">
        <form method="POST" action="<?php echo e(route('dashboard.forms.update', $form->id)); ?>">
            ...
            <div class="form-group">
                ...
                <input type="email" id="recipient_email" name="recipient_email" class="form-input" value="<?php echo e(old('recipient_email', $form->recipient_email)); ?>" readonly required>
            ...
            <div id="autoResponseFields" style="display: <?php echo e($form->auto_response_enabled ? 'block' : 'none'); ?>;;">
                <div class="form-group">
                    ...
                    <textarea 
                        ...
                        class="form-input" 
                        rows="6"
                    ><?php echo e(old('auto_response_message', $form->auto_response_message)); ?></textarea>
                    <p class="form-help">
                        Available tokens: <code>{visitor_name}</code>, <code>{site_name}</code>, <code>{form_name}</code>
                    </p>
                </div>
            </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Git-folders\000form.com\resources\views/dashboard/forms/edit.blade.php ENDPATH**/ ?>