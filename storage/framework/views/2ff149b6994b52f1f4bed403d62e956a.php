...
<footer>
  <div class="footer-inner">
    <div class="footer-top"><div class="logo-wrap" style="text-decoration:none;"><img src="<?php echo e(asset('images/logo/000formlogo-default.png')); ?>" alt="000form Logo" style="width:auto;height:45px;"/></div><p style="font-size:13.5px;color:var(--muted);max-width:340px;">Form backend made so easy — just change your action URL.</p></div>
...
</html><?php /**PATH C:\Git-folders\000form.com\resources\views/pages/home.blade.php ENDPATH**/ ?>