    ...
    <div class="body">
        ...
        <div class="revenue-card">
            <div class="left">
                ...
                <div class="amount"><?php echo e($amount); ?></div>
            </div>
            <div class="right">
                <div class="plan-badge"><?php echo e(ucfirst($planName)); ?></div>
                <span class="billing-cycle"><?php echo e(ucfirst($billingCycle)); ?> billing</span>
            </div>
        </div>
        ...
        <table class="details-table">
            <tr>
                ...
                <td class="value">#<?php echo e($userId); ?></td>
            </tr>
            <tr>
                <td class="label">Email</td>
                <td class="value user-email"><?php echo e($userEmail); ?></td>
            </tr>
            <?php if($paddleCustomerId): ?>
            <tr>
                <td class="label">Paddle Customer ID</td>
                <td class="value"><?php echo e($paddleCustomerId); ?></td>
            </tr>
            <?php endif; ?>
        </table>
        ...
        <table class="details-table">
            <tr>
                ...
                <td class="value highlight"><?php echo e(ucfirst($planName)); ?> – <?php echo e(ucfirst($billingCycle)); ?></td>
            </tr>
            <tr>
                <td class="label">Amount</td>
                <td class="value highlight"><?php echo e($amount); ?> <?php echo e(strtoupper($currency)); ?></td>
            </tr>
            <tr>
...
</html><?php /**PATH C:\Git-folders\000form.com\resources\views/emails/payment-success-admin.blade.php ENDPATH**/ ?>