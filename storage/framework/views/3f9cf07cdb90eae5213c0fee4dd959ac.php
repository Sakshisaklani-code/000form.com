...
<style>
    ...
    /* ============================================
    RENTAL APPLICATION FORM - MOBILE RESPONSIVE
    ============================================ */
    ...
    @media (max-width: 992px) {
        ...
        /* Rental Form Preview Adjustments */
        .rental-form-preview {
            padding: 1.25rem;
        }
    ...
    @media (max-width: 576px) {
        ...
        .rental-form-preview .form-note svg {
            width: 12px;
            height: 12px;
            min-width: 12px;
        }
    ...
    .rental-form-preview .form-input::placeholder {
    ...
    <section style="margin-top:4.5rem">
            ...
            <div class="container">
                <div class="hero-content">
                    ...
                    <h1 class="hero-title">
                      <span class="highlight">Rental</span><br>  Application Form
                    </h1>
                </div>
            </div>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Git-folders\000form.com\resources\views/Library/Rental-ApplicationForm.blade.php ENDPATH**/ ?>