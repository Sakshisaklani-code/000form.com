...
<?php $__env->startSection('title', 'Job Application Form - 000form Library'); ?>
...
<style>
    ...
    /* ============================================
   JOB APPLICATION FORM - MOBILE RESPONSIVE
   ============================================ */
    ...
    @media (max-width: 576px) {
        ...
        .job-form-preview .checkbox-item input[type="checkbox"] {
            width: 16px;
            height: 16px;
        }
        ...
        .job-form-preview .form-note svg {
            width: 12px;
            height: 12px;
            min-width: 12px;
        }
       ...
       <section style="margin-top:4.5rem">
            ...
            <div class="container">
                <div class="hero-content">
                    ...
                    <h1 class="hero-title">
                      <span class="highlight">Job</span><br>  Application Form
                    </h1>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Git-folders\000form.com\resources\views/Library/Job-ApplicationForm.blade.php ENDPATH**/ ?>