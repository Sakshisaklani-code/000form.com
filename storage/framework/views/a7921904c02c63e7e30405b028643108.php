...
<div class="wrapper">
    ...
    <div class="header">
        ...
        <p>
            Your <strong><?php echo e(ucfirst($planName)); ?></strong> plan has been successfully reactivated.
            <?php if($accessUntil): ?>
                Your next billing date is <strong><?php echo e($accessUntil); ?></strong>.
            <?php endif; ?>
        </p>
    </div>
    ...
    <div class="body">
        ...
        <div class="plan-display">
            ...
            <div class="pd-cycle"><?php echo e(ucfirst($billingCycle)); ?> billing</div>
        </div>
        ...
        <div class="cta-wrap">
            <a href="<?php echo e(config('app.url')); ?>/billing" class="cta-btn">View Billing Dashboard →</a>
        </div>
...
</html><?php /**PATH C:\Git-folders\000form.com\resources\views/emails/subscription-resumed.blade.php ENDPATH**/ ?>