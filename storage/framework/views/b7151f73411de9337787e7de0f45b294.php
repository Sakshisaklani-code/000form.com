...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Update {form_name} placeholder in the textarea as user types the form name
        function syncFormName() {
            const formName = nameInput.value.trim() || 'our form';
            // Only auto-update if user hasn't manually edited the textarea
        ...
        // Mark as manually edited if user types in the textarea
