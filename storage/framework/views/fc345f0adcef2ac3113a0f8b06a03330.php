...
<style>
    ...
    @media (max-width: 768px) {
        .ph-table {
            min-width: 700px; /* forces scroll instead of squeezing */
        }
    }
</style>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/000form/resources/views/billing/payment-history.blade.php ENDPATH**/ ?>