...
<head>
    ...
    <title>Plan <?php echo e($isImmediate ? 'Upgraded' : 'Upgrade Scheduled'); ?></title>
    <style>
...
<div class="wrapper">
    ...
    <div class="header">
        ...
        <div class="upgrade-badge <?php echo e($isImmediate ? 'badge-immediate' : 'badge-scheduled'); ?>">
            ⬆ &nbsp;<?php echo e($isImmediate ? 'Plan Upgraded' : 'Upgrade Scheduled'); ?>
        ...
        <p>
            ...
            <?php else: ?>
                Your plan will upgrade on <strong><?php echo e($effectiveAt); ?></strong>. No action needed.
            <?php endif; ?>
        </p>
    </div>
    ...
    <div class="body">
        ...
        <div class="plan-change">
            ...
            <div class="arrow">→</div>
            <div class="plan-pill">
                <div class="pill-label"><?php echo e($isImmediate ? 'New Plan' : 'Upgrading To'); ?></div>
        ...
        <div class="payment-card">
            <div class="pay-label"><?php echo e(ucfirst($newBilling)); ?> Plan</div>
            <div class="pay-amount"><?php echo e($amount); ?></div>
            <?php if($currency): ?>
            <div class="pay-currency"><?php echo e(strtoupper($currency)); ?></div>
            <?php endif; ?>
            <?php if($periodEnd): ?>
            <div class="pay-renewal">Next renewal on <?php echo e($periodEnd); ?></div>
            <?php endif; ?>
        </div>
        <?php endif; ?>

        
        <div class="effective-callout <?php echo e($isImmediate ? 'callout-immediate' : 'callout-scheduled'); ?>">
            <div class="callout-icon"><?php echo e($isImmediate ? '✅' : '🗓'); ?></div>
            <div class="callout-text">
                <?php if($isImmediate): ?>
                    <strong>Active now</strong>
                    Your new plan limits are live immediately. Enjoy your upgraded access!
                <?php else: ?>
                    <strong>Effective <?php echo e($effectiveAt); ?></strong>
        ...
        <div class="section-label"><?php echo e($isImmediate ? 'Upgrade Summary' : 'Change Summary'); ?></div>
