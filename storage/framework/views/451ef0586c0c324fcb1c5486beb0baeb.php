...
<head>
    ...
    <title><?php echo e($success ? 'Email Verified' : 'Verification Failed'); ?> - 000form Express</title>
    ...
    <style>
        * {
        ...
        .icon-wrapper {
            ...
            width: 88px;
            height: 88px;
            background: <?php echo e($success ? 'rgba(34, 197, 94, 0.1)' : 'rgba(239, 68, 68, 0.1)'); ?>;
            border-radius: 50%;
            border: 1px solid <?php echo e($success ? 'rgba(34, 197, 94, 0.3)' : 'rgba(239, 68, 68, 0.3)'); ?>;
            animation: pulseGlow 2s ease-in-out infinite;
        }

        @keyframes pulseGlow {
            0%, 100% {
                box-shadow: 0 0 0 0 <?php echo e($success ? 'rgba(34, 197, 94, 0.2)' : 'rgba(239, 68, 68, 0.2)'); ?>;
                transform: scale(1);
            }
            50% {
                box-shadow: 0 0 0 15px <?php echo e($success ? 'rgba(34, 197, 94, 0)' : 'rgba(239, 68, 68, 0)'); ?>;
        ...
        .icon-wrapper i {
            font-size: 2.75rem;
            color: <?php echo e($success ? '#22c55e' : '#ef4444'); ?>;
            filter: drop-shadow(0 0 8px <?php echo e($success ? 'rgba(34, 197, 94, 0.3)' : 'rgba(239, 68, 68, 0.3)'); ?>);
        }
        ...
        <div class="verify-card">
            ...
            <div class="status-icon">
                <div class="icon-wrapper">
                    <i class="bi <?php echo e($success ? 'bi-check-lg' : 'bi-x-lg'); ?>"></i>
                </div>
            </div>
            ...
            <!-- Action Button -->
            <a href="<?php echo e(route('playground.index')); ?>" class="action-btn">
                <i class="bi <?php echo e($success ? 'bi-box-arrow-in-right' : 'bi-arrow-repeat'); ?>"></i>
                <?php echo e($success ? 'Continue to Express' : 'Try Again'); ?>
...
</html><?php /**PATH C:\Git-folders\000form.com\resources\views/pages/playground-verify-result.blade.php ENDPATH**/ ?>