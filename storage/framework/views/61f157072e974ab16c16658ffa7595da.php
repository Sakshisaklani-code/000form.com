...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .alert-card .left .al-plan  { font-size: 1.4rem; font-weight: 800; letter-spacing: -0.02em; color: #00ff88; }
...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <div class="alert-card">
            <div class="left">
                <div class="al-label">Reactivated Plan</div>
                <div class="al-plan"><?php echo e(ucfirst($planName)); ?></div>
            </div>
            <div class="right">
                <div class="al-status">✓ Active</div>
