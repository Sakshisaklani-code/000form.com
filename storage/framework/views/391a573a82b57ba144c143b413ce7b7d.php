                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td style="padding: 14px 0; border-bottom: 1px solid #1a1a1a;">
                                                    ...
                                                    <div style="font-size: 15px; line-height: 1.5;">
                                                        <a href="mailto:<?php echo e($formData['sender_email']); ?>" style="color: #00ff88; text-decoration: none;">
                                                            <?php echo e($formData['sender_email']); ?>
                                            ...
                                            <tr>
                                                <td style="padding: 14px 0; border-bottom: 1px solid #1a1a1a;">
                                                    ...
                                                    <div style="font-size: 15px; color: #fafafa; line-height: 1.5;">
                                                       <?php echo nl2br(e($formData['message'])); ?>
                                            ...
                                            <?php if(!empty($formData['extra_fields'])): ?>
                                                <?php $__currentLoopData = $formData['extra_fields']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(!str_starts_with($key, '_')): ?>
                                                        <tr>
                                                            <td style="padding: 14px 0; border-bottom: 1px solid #1a1a1a;">
                                                                ...
                                                                <div style="font-size: 15px; color: #fafafa; line-height: 1.5;">
                                                                    <?php echo nl2br(e(is_array($value) ? implode(', ', $value) : $value)); ?>
                                            ...
                                            <tr>
                                                <td style="padding: 14px 0;">
                                                    ...
                                                    <div style="font-size: 13px; color: #888888; line-height: 1.5; font-family: 'Courier New', monospace;">
                                                        <?php echo e($formData['app_url'] ?? config('app.url')); ?> — Playground
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    <tr>
                        <td style="padding-top: 24px; text-align: center;">
                            <p style="margin: 0 0 6px; color: #555555; font-size: 12px; line-height: 1.6;">
                                Sent via <a href="<?php echo e(config('app.url')); ?>" style="color: #00ff88; text-decoration: none;"><?php echo e(config('app.name')); ?></a> Playground
                                to <strong style="color: #888888;"><?php echo e($formData['recipient_email']); ?></strong>
                            </p>
...
</html><?php /**PATH C:\Git-folders\000form.com\resources\views\emails\playground-submission.blade.php ENDPATH**/ ?>