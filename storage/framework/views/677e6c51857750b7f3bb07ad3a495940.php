    ...
    <div class="dashboard">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav>
                ...
                <div class="workspace-switcher-section">
                    ...
                    <form method="POST" action="<?php echo e(route('team.switch')); ?>" style="margin:0;">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="workspace_owner_id" value="<?php echo e(Auth::id()); ?>">
                        <button type="submit" class="workspace-btn <?php echo e((isset($isOwnWorkspace) && $isOwnWorkspace) ? 'active-workspace' : ''); ?>">
                            <span class="workspace-btn-inner">
                                ...
                                <span style="min-width:0;">
                                    ...
                                    <span class="workspace-role"><?php echo e(Auth::user()->email); ?></span>
                                </span>
                            </span>
                    ...
                    <form method="POST" action="<?php echo e(route('team.switch')); ?>" style="margin:0.2rem 0 0;">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="workspace_owner_id" value="<?php echo e($workspace['id']); ?>">
                        <button type="submit" class="workspace-btn <?php echo e((isset($activeWorkspaceOwnerId) && $activeWorkspaceOwnerId === $workspace['id']) ? 'active-workspace' : ''); ?>">
                            <span class="workspace-btn-inner">
                                ...
                                <span style="min-width:0;">
                                    <span class="workspace-name"><?php echo e($workspace['name']); ?></span>
                                    <span class="workspace-role"><?php echo e(ucfirst($workspace['role'])); ?></span>
                                </span>
                            </span>
                ...
                <ul class="sidebar-nav">
                    ...
                    <li>
                        <a href="<?php echo e(route('billing.portal')); ?>" class="<?php echo e(request()->routeIs('billing.portal') ? 'active' : ''); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('billing.payment-history')); ?>" class="<?php echo e(request()->routeIs('billing.payment-history') ? 'active' : ''); ?>">
            ...
            <div class="sidebar-footer">
                <ul class="sidebar-nav">
                    ...
                    <li>
                        <a href="<?php echo e(route('account.settings')); ?>" class="<?php echo e(request()->routeIs('account.settings') ? 'active' : ''); ?>">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" 
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <main class="main-content">
            ...
            <div class="workspace-banner">
                <span>
                    Viewing <strong><?php echo e($workspaceOwner?->name ?? $workspaceOwner?->email); ?></strong>'s workspace
                    as <strong><?php echo e(ucfirst($currentTeamRole ?? 'viewer')); ?></strong>
                </span>
                <form method="POST" action="<?php echo e(route('team.switch')); ?>" style="margin:0;">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="workspace_owner_id" value="<?php echo e(Auth::id()); ?>">
