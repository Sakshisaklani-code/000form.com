...
<head>
    ...
    <style>
            *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .nfm-dialog { background: var(--bg-raised); border: 1px solid var(--border); border-radius: var(--radius-lg); padding: 1.5rem; width: 100%; max-width: 680px; margin: 1rem; max-height: 90vh; overflow-y: auto; }
            ...
            .nfm-field { margin-bottom: 0.7rem; }
            ...
            .nfm-help{ font-size: 0.8rem; color: var(--text-muted); display: block; margin-top: 0.2rem; margin-bottom: 0.5rem; }
            ...
            /* Mobile menu pills - compact versions */
            .mobile-pill {
            ...
            .mobile-trigger .user-avatar-sm {
                width: 30px;
                height: 30px;
                font-size: 0.7rem;
            }

            .mobile-trigger .user-menu-name,
            .mobile-trigger .user-menu-chevron {
                display: none;
            }

            /* Mobile dropdowns - wider for touch */
            .mobile-dropdown {
                width: 200px !important;
                right: -10px !important;
            }

            /* Mobile workspace switcher specific */
            .mobile-ws-menu {
                position: relative;
            }
            ...
            @media (max-width: 768px) {
                ...
                /* Smaller text in mobile menus */
                .mobile-dropdown .dropdown-item {
                    font-size: 0.9rem;
                    padding: 0.5rem 0.7rem;
                }
                
                .mobile-dropdown .ws-switch-btn {
                    font-size: 0.8rem!important;
                }
            }
    ...
    <body>
        ...
        <div class="mobile-header">
            ...
            <div class="mobile-header-right">
                ...
                <div class="user-menu mobile-ws-menu" id="mobileWsSwitcherWrap">
                    <button class="ws-pill mobile-pill" id="mobileWsSwitcherTrigger" aria-expanded="false">
                        <span class="ws-pill-dot"></span>
                        <span style="font-family:'Outfit',sans-serif; font-size:0.8rem; font-weight:400; color:var(--text-secondary);">
                    ...
                    <div class="ws-dropdown mobile-dropdown" id="mobileWsDropdown">
                ...
                <div class="user-menu mobile-user-menu" id="mobileUserMenuWrap">
                    <button class="user-menu-trigger mobile-trigger" id="mobileUserMenuTrigger" aria-expanded="false">
                        <div class="user-avatar-sm"><?php echo e(strtoupper(substr(Auth::user()->email, 0, 1))); ?></div>
                    </button>
                    <div class="user-dropdown mobile-dropdown" id="mobileUserDropdown">
            ...
            <form method="POST" action="<?php echo e(route('dashboard.forms.store')); ?>" id="newFormQuickForm">
                    ...
                    <?php else: ?>
                        ...
                        <div class="nfm-no-projects">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('dashboard.projects.create')); ?>" class="nfm-create-project-link" style="font-size: 0.875rem;">
                ...
                <div class="nfm-field">
                    ...
                    <p class="nfm-help">
                        ...
                        Sent from <?php echo e(config('mail.from.address')); ?>.
                    </p>
                </div>
...
The {site_name} Team</textarea>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                initDropdown('mobileUserMenuTrigger', 'mobileUserDropdown');
                initDropdown('mobileWsSwitcherTrigger', 'mobileWsDropdown');
                ...
                const autoResponseCheckbox = document.getElementById('nfm_auto_response_enabled');
                const autoResponseFields = document.getElementById('nfm_autoResponseFields');
                if (autoResponseCheckbox && autoResponseFields) {
                    autoResponseCheckbox.addEventListener('change', function() {
                        autoResponseFields.style.display = this.checked ? 'block' : 'none';
                    });
                }
            });
        </script>
