...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <div class="alert-card <?php echo e($cancelType === 'scheduled_change' ? 'alert-sched' : 'alert-sub'); ?>">
            <div class="left">
                <div class="al-label">
                ...
                <div class="al-plan">
                    <?php if($cancelType === 'scheduled_change'): ?>
                        <?php echo e(ucfirst($cancelledNewPlan)); ?>

                    <?php else: ?>
                        <?php echo e(ucfirst($planName)); ?>

                    <?php endif; ?>
                </div>
            </div>
            <div class="right">
                <!-- <div class="al-type <?php echo e($cancelType === 'scheduled_change' ? 'type-sched' : 'type-sub'); ?>">
                    <?php echo e($cancelType === 'scheduled_change' ? 'Scheduled Cancel' : 'Immediate Cancel'); ?>

                </div> -->
                <span class="al-cycle"><?php echo e(ucfirst($billingCycle)); ?> billing</span>
            </div>
        </div>
        ...
        <table class="details-table">
            ...
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td class="value warning"><?php echo e($accessUntil); ?></td>
                </tr>
                <?php endif; ?>
                <tr>
...
</html><?php /**PATH C:\Git-folders\000form.com\resources\views/emails/subscription-cancelled-admin.blade.php ENDPATH**/ ?>