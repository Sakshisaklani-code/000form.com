    ...
    <div class="card">
        ...
        <div style="display: flex; flex-direction: column; gap: 1.25rem;">
            <?php $__currentLoopData = $submission->data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(!str_starts_with($key, '_') && !str_starts_with($key, 'honeypot')): ?>
                    <div>
                                            ...
                                            <div style="display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem; background: var(--bg-secondary); border-radius: 4px; border: 1px solid var(--border-color);">
                                                ...
                                                <div style="flex: 1;">
                                                    ...
                                                    <div style="font-size: 0.75rem; color: var(--text-muted); margin-top: 0.15rem;">
                                                        <?php echo e(round((int)$fileData['size'] / 1024, 2)); ?> KB
                                                ...
                                                <a href="<?php echo e(route('dashboard.submissions.download', [$form->id, $submission->id])); ?>?file_index=<?php echo e($index); ?>"
                                                   style="display: inline-flex; align-items: center; gap: 0.35rem; padding: 0.4rem 0.75rem; background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: 4px; color: var(--text); text-decoration: none; font-size: 0.8rem; <?php echo e(!$fileExists ? 'pointer-events:none;opacity:0.5;' : ''); ?>">
                                ...
                                <?php elseif(isset($value['name']) && isset($value['size']) && isset($value['path'])): ?>
                                    ...
                                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                                        ...
                                        <div style="flex: 1;">
                                            ...
                                            <div style="font-size: 0.75rem; color: var(--text-muted); margin-top: 0.15rem;">
                                                <?php echo e(round((int)$value['size'] / 1024, 2)); ?> KB
                                        ...
                                        <a href="<?php echo e(route('dashboard.submissions.download', [$form->id, $submission->id])); ?>?file_index=0"
                                           style="display: inline-flex; align-items: center; gap: 0.35rem; padding: 0.4rem 0.75rem; background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: 4px; color: var(--text); text-decoration: none; font-size: 0.8rem; <?php echo e(!$fileExists ? 'pointer-events:none;opacity:0.5;' : ''); ?>">
                                            <span><i class="bi bi-download"></i></span>
                                            Download
                                        </a>
                ...
                <?php if($submission->metadata && isset($submission->metadata['has_attachment']) && $submission->metadata['has_attachment']): ?>
                    ...
                    <?php if(isset($submission->metadata['attachment_size'])): ?>
                        <div style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid var(--border-color);">
                            ...
                            <span><?php echo e(round((int)$submission->metadata['attachment_size'] / 1024, 2)); ?> KB</span>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if(isset($submission->metadata['attachments']) && is_array($submission->metadata['attachments'])): ?>
                        ...
                        <div style="display: flex; justify-content: space-between; padding: 0.5rem 0;">
                            ...
                            <span><?php echo e(round((int)$totalSize / 1024, 2)); ?> KB</span>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Git-folders\000form.com\resources\views/dashboard/submissions/show.blade.php ENDPATH**/ ?>