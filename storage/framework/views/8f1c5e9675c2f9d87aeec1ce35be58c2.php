...
<span class="keyword">document</span>.getElementById(<span class="string">'contact-form'</span>).addEventListener(<span class="string">'submit'</span>, <span class="keyword">async function</span>(e) {
  ...
  <span class="keyword">try</span> {
    ...
    <span class="keyword">if</span> (statusCode === 200 &amp;&amp; data.success) {
      box.innerHTML = <span class="string">'&lt;p style="color:#22c55e;font-weight:500;"&gt;&#x2713; <?php echo e(addslashes($form->success_message ?? "Thank you for your submission!")); ?>&lt;/p&gt;'</span>;
      form.reset();
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/000form/resources/views/dashboard/forms/show.blade.php ENDPATH**/ ?>