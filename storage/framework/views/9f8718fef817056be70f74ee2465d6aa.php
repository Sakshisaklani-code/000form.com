...
<body>
    <div class="wrap">
        <div class="card">
            ...
            <p>
                <strong style="color:#fff;"><?php echo e($ownerName); ?></strong> has invited you to join their
                000form workspace as a <strong style="color:#fff;"><?php echo e($role); ?></strong>.
            </p>

            <div class="meta">
                <div class="meta-row">
                    <span class="meta-label">Workspace</span>
                    <span class="meta-value"><?php echo e($ownerName); ?></span>
                </div>
                <div class="meta-row">
                    <span class="meta-label">Your role</span>
                    <span class="meta-value"><?php echo e($role); ?></span>
                </div>
                <div class="meta-row">
                    <span class="meta-label">Invited email</span>
                    <span class="meta-value"><?php echo e($invitation->invitee_email); ?></span>
                </div>
                <div class="meta-row">
                    <span class="meta-label">Expires</span>
                    <span class="meta-value"><?php echo e($expiresAt); ?></span>
                </div>
            </div>

            <a href="<?php echo e($acceptUrl); ?>" class="btn">Accept Invitation →</a>
        ...
        <div class="footer">
            This invitation was sent by <?php echo e($ownerName); ?> via
            <a href="<?php echo e(config('app.url')); ?>">000form</a>.<br>
            If you didn't expect this, you can safely ignore this email.
        </div>
    </div>
</body>
</html><?php /**PATH C:\Git-folders\000form.com\resources\views/emails/team-invitation.blade.php ENDPATH**/ ?>