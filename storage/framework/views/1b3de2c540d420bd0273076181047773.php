        ...
        <div class="container">
            <div class="hero-content" style="margin-bottom: 3.5rem;">
                <div class="hero-badge">
                    ...
                    000Form Documentation • Simplify your workflow
                </div>
                
                <h1 class="hero-title">
                    Guides and references for <span class="highlight">every feature.</span>
                </h1>
                ...
                <div class="docs-section" id="quickstart">
                    ...
                    <div class="docs-section-body">
                        ...
                        <div class="note-box">
                            ...
                            <span>Not ready to sign up yet? <a href="<?php echo e(route('playground.index')); ?>" style="color:#1d4ed8;text-decoration:none;font-weight:600;">Try the Express</a> &mdash; test everything right now with no account needed.</span>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/000form/resources/views/pages/docs.blade.php ENDPATH**/ ?>