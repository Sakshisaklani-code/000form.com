...
<?php $__env->startSection('title', 'Express Guide - 000form'); ?>
                ...
                <div class="docs-section" id="quickstart">
                    ...
                    <div class="docs-section-body">
                        <div class="qs-grid">
                            <div class="qs-card">
                                ...
                                <div class="qs-card-body">
                                    ...
                                    <p>Sign up at <a href="<?php echo e(route('signup')); ?>">000form.com</a></p>
                                </div>
                            </div>
                            <div class="qs-card">
                        ...
                        <div class="note-box">
                            ...
                            <span>Not ready to sign up yet? <a href="<?php echo e(route('playground.index')); ?>" style="color:var(--blue);text-decoration:none;font-weight:600;">Try the Playground</a> &mdash; test everything right now with no account needed.</span>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.express', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Git-folders\000form.com\resources\views/pages/express-guide.blade.php ENDPATH**/ ?>