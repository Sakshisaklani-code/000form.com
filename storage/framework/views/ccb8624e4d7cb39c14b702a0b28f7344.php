        ...
        <div class="card">
            ...
            <div class="meta">
                <!-- <div class="meta-row">
                    ...
                    <span class="meta-value"><?php echo e($userName ?? '—'); ?></span>
                </div> -->
                <div class="meta-row">
                    <span class="meta-label">Email address - </span>
                    <span class="meta-value"><?php echo e($userEmail); ?></span>
                </div>
                <div class="meta-row">
                    <span class="meta-label">Registered at - </span>
                    <span class="meta-value"><?php echo e(now()->format('Y-m-d H:i:s')); ?></span>
                </div>
            </div>
            <div class="footer">
