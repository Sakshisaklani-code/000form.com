...
// ============================================================
// FILE 3a: Register middleware — Laravel 11
// In bootstrap/app.php add inside ->withMiddleware():
// ============================================================

// ->withMiddleware(function (Middleware $middleware) {
//     $middleware->alias([
//         'check.submission.limit' => \App\Http\Middleware\CheckSubmissionLimit::class,
//     ]);
// })


// ============================================================
// FILE 3b: Register middleware — Laravel 10
...
// ============================================================
// FILE 4: Apply middleware to your form submission route
// In routes/web.php find your submission route and add middleware
//
// You need to find the route that handles form submissions.
// It likely looks like one of these:
// ============================================================

// Route::post('/f/{form}', [SubmissionController::class, 'store'])
//      ->middleware('check.submission.limit');
...
// ============================================================
// FILE 5: Clear cache in ProcessPaddleWebhook job
// After updating the subscription, clear the cache so
// the next submission check gets fresh limits.
// Open app/Jobs/ProcessPaddleWebhook.php and add this
// at the end of onSubscriptionCreated() and onTransactionCompleted():
// ============================================================

// After subscription update:
// \App\Services\SubmissionGateService::clearCache($subscription->user_id);
...
// 1. Check your form submission route name:
//    php artisan route:list | grep submit

// 2. Manually lower the limit to test:
//    php artisan tinker
//    $sub = App\Models\Subscription::first();
//    $sub->update(['submissions_limit' => 2, 'submissions_used' => 0]);

// 3. Submit a form twice — third submission should be blocked

// 4. Check it was blocked:
//    $sub->fresh()->submissions_used; // should be 2

// 5. Reset:
//    $sub->update(['submissions_used' => 0, 'submissions_limit' => 200]);